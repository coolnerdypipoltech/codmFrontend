...
import brushNavMenu from "../assets/desktop/Registro/Términos y condiciones.png";
      ...
      <div style={{ padding: "20px", paddingLeft: "10%", paddingRight: "10%" }}>
        <div className="inter-font" style={{ color: "white" }}>
          ...
          <p>
            ...
            versión modificada en línea en <p></p>
          ...
          <p>
            {" "}
            ©2026 Activision Publishing, INC. ACTIVISION, CALL OF DUTY, y la
            letra estilizada M son marcas registradas de Activision Publishing,
            INC. Las demás marcas comerciales y nombres comerciales son

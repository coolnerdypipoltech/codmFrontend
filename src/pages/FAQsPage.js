  ...
  return (
    <div style={{backgroundImage: `url(${background})` , backgroundSize: "cover", backgroundPosition: "center", minHeight: "100vh", display: "flex", flexDirection: "column"}}>
      ...
      <div style={{width:"80%" , display: "flex", flexDirection: "column", alignContent: "center", justifyContent: "center", marginLeft: "10%", marginTop: "60px", gap: "16px", overflowX: "clip"}}>
        <p className="guild-font" style={{fontSize: "16px"}}>Registro y Participación</p>
        ...
        <p className="guild-font" style={{fontSize: "16px"}}>Clasificatorias Regionales</p>
        ...
        <p className="guild-font" style={{fontSize: "16px"}}>La Gran Final</p>
        ...
        <FAQsItem title={"¿Cómo puedo asistir al evento presencial?"} text={"Pre-release de tickets: Los boletos para el evento en vivo estarán disponibles a partir de las primeras semanas de marzo. Compartiremos toda la información en nuestras redes oficiales."}></FAQsItem>
